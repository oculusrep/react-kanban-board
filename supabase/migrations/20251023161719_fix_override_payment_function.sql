-- Fix the override_payment_amount function to avoid ambiguous column references
-- This version uses prefixed return column names to avoid conflicts

-- Drop the existing function first since we're changing the return type
DROP FUNCTION IF EXISTS override_payment_amount(UUID, NUMERIC);
