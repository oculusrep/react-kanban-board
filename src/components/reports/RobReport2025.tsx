...
export default function RobReport({ readOnly = false }: RobReportProps) {
  ...
  // Fixed to 2025 for historical comparison
  ...
  const fetchReportData = async () => {
    ...
    try {
      ...
      // Row 1: Booked/Closed (Booked, Executed Payable, Closed Paid with booked_date in 2025)
      ...
      // Row 4: Collected (payments with payment_received=true AND payment_received_date in 2025)
  ...
  if (loading) {
    return (
      <div className="p-8 text-center">
        ...
        <p className="mt-2 text-sm text-gray-600">Loading 2025 Rob Report...</p>
      </div>
    );
  }
    ...
    <div className="bg-white rounded-lg shadow">
      ...
      <div className="px-6 py-4 border-b border-gray-200">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">2025 Rob Report</h1>
            <p className="text-sm text-gray-500 mt-1">
              Deal pipeline and commission summary for {reportYear} (Historical)
            </p>
          </div>
          <button
      ...
      <div className="px-6 py-4 bg-gray-50 border-t border-gray-200">
        <div className="text-xs text-gray-500 space-y-1">
          <p><strong>Booked/Closed:</strong> Deals in Booked, Executed Payable, or Closed Paid stages with booked date in {reportYear}</p>
          ...
          <p><strong>Collected:</strong> Payments received in {reportYear}</p>
