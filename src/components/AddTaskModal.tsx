    ...
    const loadData = async () => {
      ...
      try {
        ...
        const [
          ...
          supabase.from('user').select('id, first_name, last_name, email, active, ovis_role').or('active.eq.true,active.is.null').in('ovis_role', ['admin', 'broker_full', 'va', 'testing']).order('first_name').order('last_name'),
