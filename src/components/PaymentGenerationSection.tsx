    ...
    <div className="bg-white border border-gray-200 rounded-lg p-6">
      ...
      <div className="space-y-4">
          ...
          <div className="space-y-3">
            ...
            {/* Regenerate Payment Splits - Always show when payments exist */}
            {hasPayments && onRegeneratePaymentSplits && (
              <div className="space-y-2">
                <button
                  onClick={onRegeneratePaymentSplits}
                  disabled={generatingPayments}
                  className={`w-full px-4 py-2 border rounded-md font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed ${
                  ...
                  title="Regenerate payment splits based on current commission splits"
                >
