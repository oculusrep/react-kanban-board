    ...
    return (
      <div>
        ...
        <InputComponent
          ...
          className={`block w-full rounded-md shadow-sm text-sm resize-none ${
            showRequiredStyling
  ...
  return (
    <div>
      ...
      <div
        ...
        onFocus={handleFocus}
        tabIndex={tabIndex || 0}
        className={`px-3 py-2 rounded-md shadow-sm border flex items-start transition-colors focus:outline-none focus:ring-2 text-sm ${
          disabled
