...
const ActivityTab: React.FC<ActivityTabProps> = ({ dealId }) => {
  const { activities, loading, error, refetch } = useActivities(dealId);
  ...
  return (
    <div className="space-y-4">
      ...
      <Section 
        ...
        help="Overview of all activities related to this deal"
      >
      ...
      <Section 
        ...
        help="Chronological list of all activities for this deal"
      >
        {/* Filters and Search */}
              ...
              <div>
                ...
                <div className="mt-6">
                  <button
                    ...
                    onClick={() => {
                      // TODO: Implement add activity modal
                      console.log('Add first activity');
                    }}
                  >
                    <PlusIcon className="w-4 h-4" />
                    Add First Activity
